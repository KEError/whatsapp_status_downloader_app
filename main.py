...
if z==True :
	...
	os.rename('/sdcard/keerrorbafus.support/.statuses',dst2)
class mainApp(App):
    sound=SoundLoader.load('/sdcard/kivy/whatsapp_status_downloader_app-main/data/music.mp3')
    def build(self):
           return Image(source ='/sdcard/kivy/whatsapp_status_downloader_app-main/data/ok.png')
